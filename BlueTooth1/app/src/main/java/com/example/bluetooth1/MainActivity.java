...
public class MainActivity extends AppCompatActivity {
    ...
    public void entraIntent(){
        Intent i = new Intent(this, SubActivity.class);
        startActivityForResult(i, INTENT_CODE);
    }
    public void spostaVariabili(){
        SubActivity.btSocket=btSocket;
        SubActivity.ConnessioneOK=ConnessioneOK;
        SubActivity.listElement=listElement;
        SubActivity.targetDevice=targetDevice;
        SubActivity.writer=writer;
    }
